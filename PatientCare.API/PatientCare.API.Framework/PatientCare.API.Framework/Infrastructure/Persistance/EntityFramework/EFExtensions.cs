...
namespace PatientCare.API.Framework.Infrastructure.Persistance.EntityFramework
{
    public static class EFExtensions
    {
        /// <summary>
        /// Creates an initial DbCommand object based on a stored procedure name using schema and or package names
        /// </summary>
        /// <param name="context">target database context</param>
        /// <param name="schemaName">database schema name</param>
        /// <param name="packageName">package name where stored procedure or function exists</param>
        ...
        /// <returns></returns>
        public static DbCommand LoadStoredProc(this DbContext context, string schemaName, string packageName, string storedProcName, int commandTimeout = 30)
        {
            ...
            if (schemaName != null)
            {
                if (packageName != null)
                {
                    storedProcName = $"{schemaName}.{packageName}.{storedProcName}";
                }
                else
                {
